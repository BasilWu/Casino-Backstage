      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">后端帐号修改</a>
            </li>
            <li>
              <a href="Manger_edit.php">后端帐号修改</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <form class="form-horizontal newoil-form" method="post" action="Manger_edit.php">
                <div class="row">
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">后端帐号修改</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <select class="form-control select2" name="u_power" id="u_power" data-placeholder="请选择"
                                ...
                                <option value="7" selected>Customer support</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">v02</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="u_name" name="u_name" value="v02"
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <select class="form-control select2" name="active" id="active" data-placeholder="请选择"
                                ...
                                <option value="N" selected>停权</option>
                              </select>
                            </div>
                          </div>
                          <div class="form-group">
