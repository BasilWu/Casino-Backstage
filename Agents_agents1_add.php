      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">添加股东数据</a>
            </li>
            <li>
              <a href="Agents_agents1_add.php">添加股东数据</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">添加股东数据</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <!--
                            	<input type="text" class="form-control digits" id="percent" max="100" name="percent" value="" placeholder="分润设置" required />
