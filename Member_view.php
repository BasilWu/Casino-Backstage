      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">会员数据浏览</a>
            </li>
            <li>
              <a href="Member_view.php">会员数据浏览</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">会员数据浏览</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">MVP会员</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">0986888888</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning" class="col-xs-12 col-sm-3 control-label no-padding-right">LINE
                              ID</label>
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">wwwbkk</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">激活</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
