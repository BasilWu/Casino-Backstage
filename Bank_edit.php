      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">公司帐户修改</a>
            </li>
            <li>
              <a href="Bank_edit.php">公司帐户修改</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">公司帐户修改</h4>
                      </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <select class="form-control select2" name="bank_num" id="bank_num" data-placeholder="请选择"
                                required>
                                <option value="1" selected>004臺灣銀行</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="bank_account" name="bank_account"
                                value="Please contact custo" placeholder="银行帐号" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="account_name" name="account_name"
                                value="Please contact custo" placeholder="银行户名" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
