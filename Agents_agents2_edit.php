      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">总代数据修改</a>
            </li>
            <li>
              <a href="Agents_agents2_edit.php">总代数据修改</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">总代数据修改</h4>
                      </div>
                        ...
                        <div class="widget-main padding-8">
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">vip666(Company's General Agent)</p>
                              <input type="hidden" name="root" id="root" value="3" />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <p class="form-control-static">vip666</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="u_name" name="u_name"
                                value="Company's General Agent" placeholder="姓名" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <!--
                            	<input type="text" class="form-control digits" id="percent" max="65" name="percent" value="50" placeholder="分润设置" required />
                                <p class="form-control-static text-danger">每月只能修改一次, 上层分润：65%</p>
                                -->
                              <input type="hidden" id="percent" name="percent" value="50" />
