                      ...
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          <div class="form-group">
                            ...
                            <label class="col-xs-12 col-sm-5 control-label" style="text-align: left;">CVS & ATM</label>
                            <input type="hidden" name="m_group" value="0" />
                            <input type="hidden" name="paymentType" value="atmncvs" />
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              ...
                              <a class='btn btn-danger' href='Payment_index.php'>取消</a>
                            </div>
                          </div>
                        </div>
                      </div>
