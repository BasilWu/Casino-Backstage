      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">优惠活动登录</a>
            </li>
            <li>
              <a href="Sales_create.php">优惠活动登录</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">优惠活动登录</h4>
                      </div>
                        ...
                        <div class="widget-main padding-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-1">
                              <input type="text" class="form-control jqdate" id="buildtime" name="buildtime"
                                value="2024-01-22" placeholder="发布日期" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6">
                              <textarea class="ckeditor" name="word"></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
