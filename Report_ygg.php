      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">9KG表查找</a>
            </li>
            <li>
              <a href="Report_ygg.php">9KG表查找</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
        ...
        $('#auto_report').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: CI_URL + "report/YGG_report/auto_report",
                cache: false,
                dataType: "json",
                  ...
                  <div class="col-xs-12 col-sm-5">
                    <div class="form-group">
                      <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-white btn-sm btn-pink"
                          id="auto_report">手动补帐(不可超过五分钟)</button>
                      </div>
                    </div>
                  </div>
                </form>
              ...
              <div class="page-header">
                <a class="btn btn-danger" href="Report_ygg.php">回上层</a>
              </div>
