              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="Payment_index_2.php">Platinum Member</a></li>
                    <li role="presentation" class=""><a href="Payment_index_3.php">Distinguished Member</a>
                    </li>
