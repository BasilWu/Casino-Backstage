                ...
                <div class="tab-content">
                  <div id="home" class="tab-pane fade in active">
                    <table id="simple-table" class="table table-bordered table-hover table-responsive">
                      ...
                      <tbody>
                        <tr id="trAH165632331090">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165632331090</div>
                            <div class="text-danger">2022-06-27 17:48:30</div>
                          </td>
                          <td>
                            ...
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-06-27 17:48:30','7')">123</a>
                            </div>
                          </td>
                          <td>99,999</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165632331090"
                              data-fee="1999.98" data-rel="tooltip" title="修改手续费">
                              2,000 </a>
                          </td>
                          <td>
                            ...
                            <div class="text-danger">实际金额：97,999</div>
                          </td>
                          <td>
                            <select class="select2" onchange="keyChange('AH165632331090',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                              <option value="3">拒絕出款</option>
                            </select>
                          </td>
                          <td>
                            <div class="btn-group">
                        ...
                        <tr id="trAH165233744489">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233744489</div>
                            <div class="text-danger">2022-05-12 14:37:24</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:24','11')">123</a>
                            </div>
                          </td>
                          <td>1,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233744489" data-fee="20"
                              data-rel="tooltip" title="修改手续费">
                              20 </a>
                          </td>
                          <td>
                            <div class="text-success">005土地銀行</div>
                            <div class="text-success">分行：qq</div>
                            <div class="text-success">帐号：qq</div>
                            <div class="text-success">户名：qq</div>
                            <div class="text-danger">实际金额：980</div>
                          </td>
                          <td>
                            <select class="select2" onchange="keyChange('AH165233744489',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233744188">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233744188</div>
                            <div class="text-danger">2022-05-12 14:37:21</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:21','11')">123</a>
                            </div>
                          </td>
                          <td>1,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233744188" data-fee="20"
                              data-rel="tooltip" title="修改手续费">
                              20 </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <select class="select2" onchange="keyChange('AH165233744188',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233743787">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233743787</div>
                            <div class="text-danger">2022-05-12 14:37:17</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:17','11')">123</a>
                            </div>
                          </td>
                          <td>1,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233743787" data-fee="20"
                              data-rel="tooltip" title="修改手续费">
                              20 </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <select class="select2" onchange="keyChange('AH165233743787',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233743386">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233743386</div>
                            <div class="text-danger">2022-05-12 14:37:13</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:13','11')">123</a>
                            </div>
                          </td>
                          <td>2,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233743386" data-fee="40"
                              data-rel="tooltip" title="修改手续费">
                              40 </a>
                          </td>
                          <td>
                            ...
                            <div class="text-success">帐号：qq</div>
                            <div class="text-success">户名：qq</div>
                            <div class="text-danger">实际金额：1,960</div>
                          </td>
                          <td>
                            <select class="select2" onchange="keyChange('AH165233743386',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233743085">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233743085</div>
                            <div class="text-danger">2022-05-12 14:37:10</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:10','11')">123</a>
                            </div>
                          </td>
                          <td>2,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233743085" data-fee="40"
                              data-rel="tooltip" title="修改手续费">
                              40 </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <select class="select2" onchange="keyChange('AH165233743085',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233742784">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233742784</div>
                            <div class="text-danger">2022-05-12 14:37:07</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:07','11')">123</a>
                            </div>
                          </td>
                          <td>2,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233742784" data-fee="40"
                              data-rel="tooltip" title="修改手续费">
                              40 </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <select class="select2" onchange="keyChange('AH165233742784',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233742383">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233742383</div>
                            <div class="text-danger">2022-05-12 14:37:03</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:03','11')">123</a>
                            </div>
                          </td>
                          <td>1,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233742383" data-fee="20"
                              data-rel="tooltip" title="修改手续费">
                              20 </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <select class="select2" onchange="keyChange('AH165233742383',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233742082">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233742082</div>
                            <div class="text-danger">2022-05-12 14:37:00</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:37:00','11')">123</a>
                            </div>
                          </td>
                          <td>1,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233742082" data-fee="20"
                              data-rel="tooltip" title="修改手续费">
                              20 </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <select class="select2" onchange="keyChange('AH165233742082',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
                        ...
                        <tr id="trAH165233741681">
                          <td>
                            vip666one <div class="text-danger">Company main station agent line</div>
                          </td>
                          <td>
                            <div class="text-info">AH165233741681</div>
                            <div class="text-danger">2022-05-12 14:36:56</div>
                          </td>
                          <td>
                            <a href="Member_index.php">
                              a123456789 </a>
                            <div class="text-danger">
                              <a href="javascript:void(0)" class="text-danger"
                                onClick="showReport('2022-05-12 14:36:56','11')">123</a>
                            </div>
                          </td>
                          <td>10,000</td>
                          <td>
                            <a href="javascript:void(0)" class="show_fee" data-orderno="AH165233741681" data-fee="200"
                              data-rel="tooltip" title="修改手续费">
                              200 </a>
                          </td>
                          <td>
                            ...
                            <div class="text-success">帐号：qq</div>
                            <div class="text-success">户名：qq</div>
                            <div class="text-danger">实际金额：9,800</div>
                          </td>
                          <td>
                            <select class="select2" onchange="keyChange('AH165233741681',this.value)"
                              data-allow-clear="false">
                              <option value="0" selected>等待處理</option>
                              <option value="1">處理完畢</option>
                              <option value="2">放棄提領</option>
