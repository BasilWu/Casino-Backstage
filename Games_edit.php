      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">游戏数据修改</a>
            </li>
            <li>
              <a href="Games_edit.php">游戏数据修改</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">游戏数据修改</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <select class="form-control select2" name="makers_num" id="makers_num"
                                ...
                                <option value="1" selected>9KG</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="game_name_en_US" name="game_name_en_US"
                                value="Paikang" placeholder="游戏名称" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="game_code" name="game_code" value="9KG-00003"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              ...
                              <span class="help-block">
                                <a class='btn btn-info btn-white'
                                  href="//game99.demonsupervisor.com/upload/active/games_20220225104200_0.png"
