      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">前台-客服链接修改送出</a>
            </li>
            <li>
              <a href="Message_configok.php">前台-客服链接修改送出</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">前台-客服链接修改送出</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          <div class="form-group">
                            <label for="inputWarning"
                              class="col-xs-12 col-sm-3 control-label no-padding-right">链接网址</label>
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="url" name="url"
                                value="https://www.facebook.com/" placeholder="链接网址" />
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              ...
                              <a class='btn btn-danger' href='Message_config.php'>取消</a>
                            </div>
                          </div>
                        </div>
                      </div>
