      ...
      <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="javascript:void(0)">会员金流修改</a>
            </li>
            <li>
              <a href="Payment_edit.php">会员金流修改</a>
            </li>
          </ul><!-- /.breadcrumb -->
        </div>
                  ...
                  <div class="col-xs-12 col-sm-12">
                    <div class="widget-box widget-color-blue2">
                      <div class="widget-header">
                        <h4 class="widget-title lighter smaller">会员金流修改</h4>
                      </div>
                      <div class="widget-body">
                        <div class="widget-main padding-8">
                          <div class="form-group">
                            ...
                            <label class="col-xs-12 col-sm-5 control-label" style="text-align: left;">信用卡</label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <select class="form-control" id="libs" name="libs">
                                ...
                                <option value="cgpay" selected>幣安</option>
                                <option value="gomypay">萬事達</option>
                                <option value="ufopay">金恆通</option>
                                <option value="bitcompay">Bitcom</option>
                                <option value="okwepay">Okwepay</option>
                                <option value="wecashpay">Wecashpay</option>
                                <option value="ccking">Ccking</option>
                                <option value="payware">PayWare</option>
                                <option value="fagopay">FA幣安</option>
                                <option value="go88pay">GO88</option>
                              </select>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <label class="radio-inline">
                                <input type="radio" name="enable" id="enable0" value="0">停用 </label>
                              <label class="radio-inline">
                                <input type="radio" name="enable" id="enable1" value="1" checked>激活 </label>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
                            ...
                            <div class="col-xs-12 col-sm-5">
                              <input type="text" class="form-control" id="merchant" name="merchant" value="AB"
                          ...
                          <div class="form-group">
                            <label for="inputWarning"
                              class="col-xs-12 col-sm-3 control-label no-padding-right">当前累计金额</label>
                            <label class="col-xs-12 col-sm-5 control-label" style="text-align: left;">333000</label>
                          </div>
                          <div class="form-group">
                            <label for="inputWarning"
